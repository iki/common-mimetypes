#!/usr/bin/env python
from common_mimetypes import __version__, __doc__, __docformat__
...
properties = dict(
    name = 'common-mimetypes',
    version = __version__,
    license = 'BSD',
    url = 'https://github.com/iki/common-mimetypes',
    # download_url = 'https://github.com/iki/common-mimetypes/tarball/v%s' % __version__,
